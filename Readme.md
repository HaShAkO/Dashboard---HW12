...
<img alt="Landing page large screen" src="resources/landing-lg.png" width=600>
...
Large screen:
![Landing page large screen](resources/landing-lg.png)

Small screen:
![Landing page small screen](resources/landing-sm.png)


#### Comparisons page

Large screen:
![comparison page large screen](resources/comparison-lg.png)

Small screen:
![comparison page small screen](resources/comparison-sm.png)

#### Data page

Large screen:
![data page large screen](resources/data-lg.png)

Small screen:
![data page small screen](resources/data-sm.png)
...
Large screen:
![visualize page large screen](resources/visualize-lg.png)

Small screen:
![visualize page small screen](resources/visualize-sm.png)

#### Navigation menu

Large screen:
![nav menu large screen](resources/nav-lg.png)

Small screen:
![nav menu small screen](resources/nav-sm.png)
